...
import com.begletsov.parus.databinding.ActivitySettingsBinding;
import com.begletsov.parus.ui.home.DialogChooseFastAction;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.checkHeart.setOnCheckedChangeListener((buttonView, isChecked) -> {
            if (isChecked) {
                ...
                serviceViewModel.stopHeartRateService(true);
        });
        binding.checkGeo.setOnCheckedChangeListener((buttonView, isChecked) -> {
            ...
            if (isChecked) {
                ...
                serviceViewModel.stopGeoLocationService(true);
        });
