...
import com.begletsov.parus.services.GeoLocationService;
import com.begletsov.parus.services.HeartRateService;
import com.begletsov.parus.services.OnlineService;
import com.begletsov.parus.services.WorkService;
...
public class ServiceRepository {
    ...
    public void stopGeoLocationService(Context context, boolean stop) {
    ...
    public void stopHeartRateService(Context context, boolean stop) {
    ...
    public void stopAllServices(Context context) {
        ...
        stopGeoLocationService(context, false);
        stopHeartRateService(context, false);
